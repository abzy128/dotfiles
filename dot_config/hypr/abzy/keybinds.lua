...
--hl.bind(kb({ mainMod, "CONTROL", "SPACE" }), hl.dsp.window.float(not hl.get_active_window().floating))
...
hl.bind(kb({ mainMod, "minus" }), hl.dsp.focus({ workspace = hl.get_active_workspace().id - 1 }))
hl.bind(kb({ mainMod, "equal" }), hl.dsp.focus({ workspace = hl.get_active_workspace().id + 1 }))
